...
import com.nagornov.CorporateMessenger.infrastructure.persistence.kafka.transfer.deserializer.KafkaNotificationDTODeserializer;
...
public class KafkaNotificationConsumer {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, KafkaNotificationDTO> kafkaNotificationContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, KafkaNotificationDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    @Bean
    public ConsumerFactory<String, KafkaNotificationDTO> kafkaNotificationConsumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaProperties.getBootstrapServers());
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaGroup.NOTIFICATION_GROUP_NAME);
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new KafkaNotificationDTODeserializer(objectMapper)
        );
    }
}
