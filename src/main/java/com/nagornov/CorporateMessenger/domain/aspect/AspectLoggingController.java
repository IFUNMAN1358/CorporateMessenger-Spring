...
public class AspectLoggingController {
    ...
    public Object logControllerExecution(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.info("Controller {} started | {}", methodName, controllerArgsFormatter(joinPoint));

            Object result = joinPoint.proceed();

            log.info("Controller {} finished", methodName);

            return result;

        } catch (Exception e) {
            log.error("Controller {} failed", methodName, e);
            throw e;
        }
    }
